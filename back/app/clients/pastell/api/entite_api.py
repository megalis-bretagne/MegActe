...
class EntiteApi(ApiPastell):
    ...
    def _build_tree_entite(
        self, entites: List[EntiteInfo]
    ) -> List[EntiteInfoWithChild]:
        """
        ...
        for entite in entites:
            entite_dict[entite.id_e] = EntiteInfoWithChild(
                **entite.model_dump(), child=[]
            )
        ...
        def _complete(
            ...
            for id_e in all_entite_ids:
                if id_e not in entite_mere_ids:  # si feuille
                    ...
                    entite_mere = (
                        group_entite[id_mere] if id_mere in group_entite else None
                    )
            ...
            entite_mere_ids = set(
                [entite.entite_mere for entite in list(entite_dict.values())]
            )
