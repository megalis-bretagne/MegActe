      ...
      <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
        <table class="min-w-full table-auto text-sm">
          ...
          <tr>
            ...
            <th class="px-4 py-3 hidden sm:table-cell"><div class="h-3 w-16 bg-gray-200 rounded animate-pulse" /></th>
          ...
          <tr v-for="i in 8" :key="i">
            <td class="px-4 py-3"><div class="h-3 bg-gray-100 rounded animate-pulse" :style="`width: ${60 + (i * 13) % 30}%`" /></td>
            <td class="px-4 py-3 hidden sm:table-cell"><div class="h-3 w-24 bg-gray-100 rounded animate-pulse" /></td>
            <td class="px-4 py-3"><div class="h-5 w-28 bg-blue-50 rounded-full animate-pulse" /></td>
            <td class="px-4 py-3 hidden sm:table-cell"><div class="h-3 w-32 bg-gray-100 rounded animate-pulse" /></td>
          </tr>
          </tbody>
        </table>
      </div>
