...
<template>
  <aside class="w-64 shrink-0 bg-white border-r border-gray-200 min-h-screen">
    ...
    <div class="p-3 border-b border-gray-100">
      <button
          :class="selectedFlux === null || selectedFlux === undefined
    ...
    <!-- Types de dossiers -->
    <div class="p-3">
      <h2 class="text-xs font-semibold text-gray-400 uppercase tracking-wide px-3 mb-2">
        Types de dossiers
      </h2>
