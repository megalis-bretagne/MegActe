...
const showRightEllipsis = computed(() => props.totalPages > props.pageActive + pagesToShow / 2 + 2);
</script>

<template>
  <nav role="navigation" aria-label="Pagination" class="flex justify-center items-center py-3 px-4">
